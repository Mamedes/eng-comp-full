...
public class ArtistaUseCaseConfig {
    ...
    @Bean
    public GetArtistaDetalheUseCase getArtistaDetalheUseCase(
            AlbumGateway albumGateway,
            AlbumImagemGateway albumImagemGateway
    ) {
        return new GetArtistaDetalheUseCase(artistaGateway, albumGateway, albumImagemGateway);
    }
}
