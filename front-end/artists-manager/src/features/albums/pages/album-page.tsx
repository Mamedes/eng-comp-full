    ...
    return (
        <div className="container mx-auto px-6 py-10 animate-in fade-in duration-500">
                        ...
                        <div key={album.albumId} className="group bg-zinc-900/40 border border-white/5 p-6 rounded-3xl hover:bg-zinc-900 transition-all hover:-translate-y-1 hover:border-purple-500/30 shadow-xl">
                            <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                <button
                                    ...
                                    className="p-2 bg-zinc-800 hover:text-blue-400 rounded-lg"
                                >
                                    <Edit3 size={16} />
                                </button>
                                <button
                                    onClick={() => handleDelete(album.albumId)}
                                    className="p-2 bg-zinc-800 hover:text-red-400 rounded-lg"
                                >
                                    <Trash2 size={16} />
                                </button>
                            </div>
                            ...
                            <h3 className="text-xl font-bold text-white mb-1 truncate" title={album.albumTitulo}>
                                {album.albumTitulo}
                            </h3>
            ...
            <div className="mt-12 flex justify-center gap-2">
                ...
                <span className="px-4 py-2 bg-zinc-900 rounded-lg font-bold">
                    {page + 1} / {totalPages || 1}
                </span>
                <button
